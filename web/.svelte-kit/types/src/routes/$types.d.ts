...
type LayoutRouteId = RouteId | "/" | "/docs" | "/docs/[...slug]" | "/docs/api-reference/overview" | "/docs/getting-started/installation" | "/docs/user-guide/custom-panels" | "/docs/user-guide/keyboard-shortcuts" | "/docs/user-guide/mobile-usage" | "/docs/user-guide/terminal-persistence" | "/login" | null
