...
type LayoutRouteId = RouteId | "/" | "/code-editor-demo" | "/color-picker-test" | "/command-palette-demo" | "/docs" | "/docs/[...slug]" | "/docs/api-reference/overview" | "/docs/getting-started/installation" | "/docs/user-guide/custom-panels" | "/docs/user-guide/keyboard-shortcuts" | "/docs/user-guide/mobile-usage" | "/docs/user-guide/terminal-persistence" | "/file-explorer-demo" | "/layout-test" | "/login" | "/mobile-test" | "/panel-menu-demo" | "/panel-test" | "/terminal-test" | "/test" | "/test-ws" | null
